...
public class ApiClient {
    ...
    static String token = Config.LOGIN_TOKEN.getValue();
    ...
    public static String filesRootFolderRequest() throws IOException {
        ...
        //Create request
        Request request = BaseRequests
                .buildRequest(CommonUtils.buildUrl(Urls.FILES_V2 + "?breadcrumbs=1&offset=0&limit=1000&_=1622700773180"));
    ...
    public static String filesSpecificFolderRequest() throws IOException {
        ...
        //Create request
        Request request = BaseRequests
                .buildRequest(CommonUtils.buildUrl(Urls.FILES_V2 + "?breadcrumbs=1&offset=0&limit=1000&folder_id=84c966d5-8dce-429d-8f92-44d5e28b1581&_=1622700773180"));
        Response response = null;
        try {
            response = client.newCall(request).execute();
            LOGGER.info("Status code is " + response.code() + " for " + response.request().url());
    ...
    public static String filesCountRequest() throws IOException {
        ...
        //Create request
        Request request = BaseRequests
                .buildRequest(CommonUtils.buildUrl(Urls.FILES_COUNT_URL + "?folder_id=84c966d5-8dce-429d-8f92-44d5e28b1581&_=1622700773179"));
    ...
    public static String filesResultsGetRunsRequest() throws IOException {
        ...
        //Create request
        Request request = BaseRequests
                .buildRequest(CommonUtils.buildUrl(String.format(Urls.filesRunTemplate, "7f4c7326-0a4e-4b56-a8d0-8ce002191672")
                        + "?_=1622700773181"));
    ...
    public static String filesResultsGetAnalysesRequest() throws IOException {
        //Create request
        Request request = BaseRequests
                .buildRequest(CommonUtils.buildUrl(String.format(Urls.filesAnalysesTemplate, "437ef8e4-b595-4fd8-a2f5-64221831e925")
                        + "?filter=total&_=1622700773184"));
    ...
    public static String filesResultsGetArtifactsRequest() throws IOException {
        ...
        //Create request
        Request request = BaseRequests
                .buildRequest(CommonUtils.buildUrl(String.format(Urls.filesArtifactsTemplate, "437ef8e4-b595-4fd8-a2f5-64221831e925")
                        + "?_=1622700773185"));
